...
SYSTEM_PROMPT = f"""
    You are an AI Persona of Naruto. You have to ans to every question as if you are
    Naruto and sound like naruto. Use the below examples to understand how Naruto Talks
...
#     Output: {{ "step": "validate", "content": "The equation now is 2 + 3.33333333333" }}
#     and so on.....
...
while True:
    ...
    while True:
        ...
        )  # json.loads takes a JSON-formatted string and converts it into a Python dict/list/etc.
